...
class ZagdxWorld(World):
    """
    A port of ZA (originally for the CD-i) written in Java with libGDX.
    """
    ...
    web = web_world.ZagdxWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "apquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = apquest_options.ZagdxOptions
    options: apquest_options.ZagdxOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    origin_region_name = "Overworld Region 1 (Below Andor)"
    ...
    def create_item(self, name: str) -> items.ZagdxItem:
