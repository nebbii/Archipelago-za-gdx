...
def set_all_entrance_rules(world: ZagdxWorld) -> None:
    ...
    def can_cross_andor(state: CollectionState) -> bool:
        return state.has("Red Boots", world.player)

    def can_enter_shrine_of_earth(state: CollectionState) -> bool:
        return state.has("Shrine of Earth Ladder Placed", world.player)
    ...
    #set_rule(overworld_region_1_to_shrine_of_earth, can_enter_shrine_of_earth)
    #set_rule(overworld_region_1_to_overworld_region_2, can_cross_andor)
...
def set_all_location_rules(world: ZagdxWorld) -> None:
    ...
    add_rule(goriya_boomerang_drop, lambda state: state.has_any(("Wand", "Boomerang", "Jade Ring"), world.player))
